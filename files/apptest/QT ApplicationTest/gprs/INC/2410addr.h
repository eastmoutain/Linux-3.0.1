...
#define rALMDATE    (*(volatile unsigned char *)0x57000060) //Alarm day
...
#define rBCDDATE    (*(volatile unsigned char *)0x5700007c) //BCD day
#define rBCDDAY   (*(volatile unsigned char *)0x57000080) //BCD date
