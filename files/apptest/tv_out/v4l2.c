...
*/
        printf("VIDIOC_QUERYCAP ing....\n");

	if((n =(ioctl(v4l2_fd, VIDIOC_QUERYCAP, &caminfo)))<0)
	 	printf("Error: failed to get camera info.%d\n",n);


        printf("VIDIOC_S_INPUT ing....\n");
	id = 0;
	if((n =(ioctl(v4l2_fd, VIDIOC_S_INPUT, &id)))<0)
		printf("VIDIOC_S_INPUT error\n");



        printf("VIDIOC_S_FMT ing....\n");
	...
	fmt.fmt.pix.pixelformat = V4L2_PIX_FMT_RGB565;
        ...
        printf("VIDIOC_S_OUTPUT ing....\n");
	id = 0;
	if((n =(ioctl(v4l2_fd, VIDIOC_S_OUTPUT, &id)))<0)
		printf("VIDIOC_S_OUTPUT error\n");


        printf("V4L2_STD_STD ing....\n");
        id1 = V4L2_STD_NTSC_M;
        //id1 = V4L2_STD_PAL;
	if((n =(ioctl(v4l2_fd, VIDIOC_S_STD, &id1)))<0)
		printf("VIDIOC_S_STD error\n");


        printf("VIDIOC_S_CTRL ing....\n");
	ctrl.id = 0x08000000;
	ctrl.value = 0;
	if((n =(ioctl(v4l2_fd, VIDIOC_S_CTRL, &ctrl)))<0)
		printf("VIDIOC_S_CTRL error\n");


        printf("VIDIOC_S_TVOUT_ON ing....\n");
	if((n =(ioctl(v4l2_fd, VIDIOC_S_TVOUT_ON, NULL)))<0)
		printf("VIDIOC_S_TVOUT_ON error\n");
